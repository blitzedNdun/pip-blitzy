...
class TestCommandBypass:
    """Command-specific bypass behavior testing for commands.

    Tests commands with ignore_require_venv=True.
    """
    ...
    def test_bypass_commands_ignore_require_venv(
        ...
        """Test that bypass commands ignore virtualenv requirement.

        Tests behavior when not in virtualenv.
        """
